...
public class UIManager : MonoBehaviour
{
    ...
    public void Finish()
    {
        ...
        uIElements.ResolutionBG.color = parameters.FinalBGColor;
        uIElements.ResolutionStateInfoText.text = "FINAL SCORE";
        var currentScore =  StartCoroutine(CalculateScore());
        ...
        // var obj = GameObject.Find("/FormScene/Canvas/Panel/Login");
        //usernameid = obj.GetComponent();
        StartCoroutine(AddScore(userid.ToString(), currentScore.ToString()));
    ...
    IEnumerator AddScore(string userid, string score)
    {
        ...
        WWW www = new WWW("http://localhost:4433/Zickvi/score.php",form);
        yield return www;
        string dataScore = www.text;
    ...
    {
        string[] inputs = textStream.Split(new char[] {'\n'}, StringSplitOptions.RemoveEmptyEntries);
    }
    ...
    IEnumerator CalculateScore()
    {
        ...
        var scoreValue = 0;
        bool scoreMoreThanZero = events.CurrentFinalScore > 0;
    ...
    void CreateAnswers(Question question)
    {
        ...
        for (int i = 0; i < question.Answers.Length; i++)
        {
            ...
            offset = offset - (newAnswer.Rect.sizeDelta.y + parameters.Margins);
